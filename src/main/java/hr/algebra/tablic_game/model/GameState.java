...
public class GameState implements Serializable {
   ...
   // private String playerThreeName;
    ...
    public GameState(String playerOneName, Boolean playerOneTurn, Boolean playerTwoTurn, Boolean playerThreeTurn, Boolean playerFourTurn, List<Card> cardsOnTable, List<Card> playerOneCardsPicked, List<Card> playerTwoCardsPicked, List<Card> playerThreeCardsPicked, List<Card> playerFourCardsPicked, List<Card> playerOneCurrentCardsList, List<Card> playerTwoCurrentCardsList, List<Card> playerThreeCurrentCardsList, List<Card> playerFourCurrentCardsList, List<ImageView> playerTwoCardsPlaceholder, List<ImageView> playerThreeCardsPlaceholder, List<ImageView> playerFourCardsPlaceholder,List<ImageView> playerOneCardsPlaceholder) {
        this.cellStateList = new ArrayList<>();
    ...
    public Boolean getPlayerThreeTurn() {
        return playerThreeTurn;
    }

    public void setPlayerThreeTurn(Boolean playerThreeTurn) {
        this.playerThreeTurn = playerThreeTurn;
    }

    public Boolean getPlayerFourTurn() {
        return playerFourTurn;
    }

    public void setPlayerFourTurn(Boolean playerFourTurn) {
        this.playerFourTurn = playerFourTurn;
    }
    ...
    public List<Card> getPlayerThreeCardsPicked() {
        return playerThreeCardsPicked;
    }

    public void setPlayerThreeCardsPicked(List<Card> playerThreeCardsPicked) {
        this.playerThreeCardsPicked = playerThreeCardsPicked;
    }

    public List<Card> getPlayerFourCardsPicked() {
        return playerFourCardsPicked;
    }

    public void setPlayerFourCardsPicked(List<Card> playerFourCardsPicked) {
        this.playerFourCardsPicked = playerFourCardsPicked;
    }
    ...
    public List<ImageView> getPlayerThreeCardsPlaceholder() {
        return playerThreeCardsPlaceholder;
    }

    public void setPlayerThreeCardsPlaceholder(List<ImageView> playerThreeCardsPlaceholder) {
        this.playerThreeCardsPlaceholder = playerThreeCardsPlaceholder;
    }

    public List<ImageView> getPlayerFourCardsPlaceholder() {
        return playerFourCardsPlaceholder;
    }

    public void setPlayerFourCardsPlaceholder(List<ImageView> playerFourCardsPlaceholder) {
        this.playerFourCardsPlaceholder = playerFourCardsPlaceholder;
    }
}
